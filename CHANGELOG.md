...
## [8.0.0](https://github.com/percyfal/snakemake/compare/v7.14.0...v8.0.0) (2022-09-02)
...
* Add `shadow: "copy-minimal"` directive ([#1155](https://github.com/percyfal/snakemake/issues/1155)) ([1803f0b](https://github.com/percyfal/snakemake/commit/1803f0b4090d812df0c164653b26502fd130d326))
...
* add flag --draft-notebook for generating a skeleton notebook for manual editing (e.g. in VSCode). ([#1284](https://github.com/percyfal/snakemake/issues/1284)) ([d279322](https://github.com/percyfal/snakemake/commit/d2793223f914790c07b25363cb9b314ef166cb3e))
...
* Add more informative errors when evaluation of `--default-resources` fails ([#1192](https://github.com/percyfal/snakemake/issues/1192)) ([b3c4e68](https://github.com/percyfal/snakemake/commit/b3c4e687c87c75075393cef842b129dcec70e7f6))
...
* Add support for rust scripts (enabling directly integrated ad-hoc robust high performance scripting) ([#1053](https://github.com/percyfal/snakemake/issues/1053)) ([f0e8fa2](https://github.com/percyfal/snakemake/commit/f0e8fa285437a02ca7edcf87334bf00cb347064a))
* Added timestamp to each log message ([#1304](https://github.com/percyfal/snakemake/issues/1304)) ([a5769f0](https://github.com/percyfal/snakemake/commit/a5769f0baeaa829b7813dee8c78902edbb42cf4b))
* Adding --cluster-cancel and --cluster-cancel-nargs ([#1395](https://github.com/percyfal/snakemake/issues/1395)) ([0593de1](https://github.com/percyfal/snakemake/commit/0593de134499712929ba75e65f65df90491eac2e))
* adding default_target directive for declaring default target rules that are not the first rule in the workflow. ([#1358](https://github.com/percyfal/snakemake/issues/1358)) ([638ec1a](https://github.com/percyfal/snakemake/commit/638ec1a983741cd7ba8faaf1a9dc76ae43d012e5))
...
* allow prefix definition in module statements ([#1310](https://github.com/percyfal/snakemake/issues/1310)) ([29e6540](https://github.com/percyfal/snakemake/commit/29e6540aac95b08b5e386a8478bd2013334e5954))
* Allow to mark all output files as temp with --all-temp ([#1097](https://github.com/percyfal/snakemake/issues/1097)) ([0ac3b38](https://github.com/percyfal/snakemake/commit/0ac3b3806c065d0ec3a551a5992faf30ddcf0576))
* autoconvert Path objects to str when passing to R or Julia scripts ([80ec513](https://github.com/percyfal/snakemake/commit/80ec51322f8134180c52c20b0a9dc6980df6c1bc))
...
* cluster sidecar ([#1397](https://github.com/percyfal/snakemake/issues/1397)) ([b992cd1](https://github.com/percyfal/snakemake/commit/b992cd19dc1c011f536e3662a3ddffc8b1bb9f67))
...
* fail with an error if snakemake cannot write job metadata. ([#1273](https://github.com/percyfal/snakemake/issues/1273)) ([cd968cd](https://github.com/percyfal/snakemake/commit/cd968cd03437ad6db1d791f5d7ae5295b9754137))
...
* implement support for removing GFAL remote files ([#1103](https://github.com/percyfal/snakemake/issues/1103)) ([25943e5](https://github.com/percyfal/snakemake/commit/25943e5630ff6d83afa5cba28edf473ce2ca87da))
...
* specify conda environments via their name ([#1340](https://github.com/percyfal/snakemake/issues/1340)) ([735ab23](https://github.com/percyfal/snakemake/commit/735ab2301d0905ea054ad6efa3150acb296d0e78))
...
* support for post deploy scripts ([#1325](https://github.com/percyfal/snakemake/issues/1325)) ([e5dac4f](https://github.com/percyfal/snakemake/commit/e5dac4ff297b7aeeb1e1a0bbdd03cb967cee3011))
* support XRootD as a default remote provider ([#1017](https://github.com/percyfal/snakemake/issues/1017)) ([fe03157](https://github.com/percyfal/snakemake/commit/fe03157c31210984fce53c35d5fb87b20d278fe7))
* template rendering integration (yte and jinja2), require Python 3.6 as minimum version (f-string support) ([#1410](https://github.com/percyfal/snakemake/issues/1410)) ([e1cbde5](https://github.com/percyfal/snakemake/commit/e1cbde5a378a29e3e7c7c16c73e08b35afa47a56))
...
* --conda-frontend value not passed on to cluster jobs ([#1317](https://github.com/percyfal/snakemake/issues/1317)) ([df46ddb](https://github.com/percyfal/snakemake/commit/df46ddb37022b291a4feca22fd0fbcf8773e7d03))
...
* add quotes to each item of the wait_for_files list ([#1160](https://github.com/percyfal/snakemake/issues/1160)) ([72856ed](https://github.com/percyfal/snakemake/commit/72856edd12fbe29d723731c6f596f05cd2b59c0e))
* add_stylesheet() was deprecated in Sphing v1.8 ([#1071](https://github.com/percyfal/snakemake/issues/1071)) ([#1076](https://github.com/percyfal/snakemake/issues/1076)) ([0a79b33](https://github.com/percyfal/snakemake/commit/0a79b331ddb644693150171440fcffe76291524a))
* Adds fixes for the first two MREs in [#823](https://github.com/percyfal/snakemake/issues/823) ([#1215](https://github.com/percyfal/snakemake/issues/1215)) ([cfd2f89](https://github.com/percyfal/snakemake/commit/cfd2f890a0af57628f7b9278d8d43f59b7006825))
...
* AmbiguousRuleException bug caused by weak ordering of rules ([#1124](https://github.com/percyfal/snakemake/issues/1124)) ([7f54c39](https://github.com/percyfal/snakemake/commit/7f54c391f2821655ed168bcdafad6d07b96fcec7))
* async_run to allow nested event loops. ([#1170](https://github.com/percyfal/snakemake/issues/1170)) ([5dc6bbd](https://github.com/percyfal/snakemake/commit/5dc6bbd440ac46e81a926b6749969b98b7e33a9f))
* atomic job error display ([#1326](https://github.com/percyfal/snakemake/issues/1326)) ([aa2c265](https://github.com/percyfal/snakemake/commit/aa2c2652608d3e95ad7fb568df09ef1ae09e1def))
...
* avoid mutable default argument ([#1330](https://github.com/percyfal/snakemake/issues/1330)) ([978cc93](https://github.com/percyfal/snakemake/commit/978cc9327ce7deb517ad609977e1ce432c58c5e2))
* avoid superfluous calls of conda info that have slowed down Snakemake since 6.4.1. ([#1099](https://github.com/percyfal/snakemake/issues/1099)) ([e990927](https://github.com/percyfal/snakemake/commit/e9909273c22a316dbd7301a243498e3c2a372642))
...
* Bugfix tes add files ([#1133](https://github.com/percyfal/snakemake/issues/1133)) ([8892bf2](https://github.com/percyfal/snakemake/commit/8892bf25d9d981a4032d5a1b525960ba3bdd1aec))
* caching process ([#1225](https://github.com/percyfal/snakemake/issues/1225)) ([0825a29](https://github.com/percyfal/snakemake/commit/0825a29e46c08b200efe6bd0c66acf1e6828eed8))
...
* consider post-deploy script for env hashing   ([#1363](https://github.com/percyfal/snakemake/issues/1363)) ([d50efd9](https://github.com/percyfal/snakemake/commit/d50efd9d16d029fb0e5b14b182882c71a20552bb))
* convert conda env to string before checks ([#1382](https://github.com/percyfal/snakemake/issues/1382)) ([7a8da9f](https://github.com/percyfal/snakemake/commit/7a8da9fbf01a037a99ebaa3732fe25e87a96fcd2))
...
* Disable Persistence cache for snakemake jobs ([#1159](https://github.com/percyfal/snakemake/issues/1159)) ([7110f9d](https://github.com/percyfal/snakemake/commit/7110f9d2e7ee3f350bd1da3c5b4aab98c06725a1))
...
* display wrapper or external script code in report [#1393](https://github.com/percyfal/snakemake/issues/1393) ([#1404](https://github.com/percyfal/snakemake/issues/1404)) ([a007bd1](https://github.com/percyfal/snakemake/commit/a007bd11fb49a5765a643ec78e19f30b3a10dfab))
...
* don't raise WorkflowError when entry is empty ([#1368](https://github.com/percyfal/snakemake/issues/1368)) ([1fc6f7b](https://github.com/percyfal/snakemake/commit/1fc6f7b5d7e7d7f40baab961db89c4b59c950bf7))
* Draft notebook filename with wildcards and params. ([#1352](https://github.com/percyfal/snakemake/issues/1352)) ([11d4dc8](https://github.com/percyfal/snakemake/commit/11d4dc88598ffb901450bd4e076b91f4e27d37b0))
* dummy release ([e4dca50](https://github.com/percyfal/snakemake/commit/e4dca508f6cbd3427d8580ef61f274f909ec8bab))
* efficient job status checking when using DRMAA API (this should yield much better parallelization and performance when using --drmaa) ([#1156](https://github.com/percyfal/snakemake/issues/1156)) ([ac004cb](https://github.com/percyfal/snakemake/commit/ac004cb19cebd4efb5e38f6039861a2810c702ff))
* enable usage of job grouping in GLS ([#1054](https://github.com/percyfal/snakemake/issues/1054)) ([d243c22](https://github.com/percyfal/snakemake/commit/d243c22ff494b63bd5e07b7c5bf1f6ff32539cde))
...
* env file usage after changes to source file handling (inspired by [#1233](https://github.com/percyfal/snakemake/issues/1233) and [#1211](https://github.com/percyfal/snakemake/issues/1211)). ([#1236](https://github.com/percyfal/snakemake/issues/1236)) ([3ac8e85](https://github.com/percyfal/snakemake/commit/3ac8e858a7b908326922c8f68cae512b1250e906))
...
* fix assertion error in conda env file spec when applying wildcards (thanks [@ddesvillechabrol](https://github.com/ddesvillechabrol)) ([#1377](https://github.com/percyfal/snakemake/issues/1377)) ([6200652](https://github.com/percyfal/snakemake/commit/6200652b9aff2362a63581cee58eb9f9cae189da))
...
* fix function call when creating report and hashes for between workflow caching ([#1198](https://github.com/percyfal/snakemake/issues/1198)) ([a4f6836](https://github.com/percyfal/snakemake/commit/a4f68365125c357f30510d0e61036f98b9d3aa69))
* fix issue when generating unit tests for rules with directory output ([#1385](https://github.com/percyfal/snakemake/issues/1385)) ([7db614f](https://github.com/percyfal/snakemake/commit/7db614fa1753179d2cdc20095df17d5ac2885ad0))
* fix None type error when invoking Workflow object manually ([#1366](https://github.com/percyfal/snakemake/issues/1366)) ([fca3895](https://github.com/percyfal/snakemake/commit/fca3895430c206fc159e71622ee567f77566980d))
* fix path returned by get_source() ([ee05315](https://github.com/percyfal/snakemake/commit/ee053153d2f44156171c127307cb110791b7624a))
* fix pepfile handling in case of module usage ([#1387](https://github.com/percyfal/snakemake/issues/1387)) ([f097a76](https://github.com/percyfal/snakemake/commit/f097a761472248d779113cdb22b5274395828bcb))
...
* fix source cache handling for remote source files retrieved via github() or gitlab() tags. ([#1322](https://github.com/percyfal/snakemake/issues/1322)) ([6e2ecd2](https://github.com/percyfal/snakemake/commit/6e2ecd26e48eb64fa04c9c38dde591857e03c722))
* fix source retrieval during between workflow caching and report generation ([2394ca4](https://github.com/percyfal/snakemake/commit/2394ca4a23a6b2792397bc9efc09945f01d1963b))
...
* fixed code change detection when using modules ([#1264](https://github.com/percyfal/snakemake/issues/1264)) ([b571e09](https://github.com/percyfal/snakemake/commit/b571e09ce452f6a1a95395e1c3c8b9e3f83867ad))
...
* fixed display of any exceptions and errors from within a workflow definition ([23d40d9](https://github.com/percyfal/snakemake/commit/23d40d99614a88fd3c596d05e6915509ae43d4ce))
...
* Ga4gh tes bugfixes ([#1127](https://github.com/percyfal/snakemake/issues/1127)) ([af21d6c](https://github.com/percyfal/snakemake/commit/af21d6c2b125c22ef3dbc36a0a6a67a1874549c7))
...
* handle config file extension/overwriting more explicitly ([#1251](https://github.com/percyfal/snakemake/issues/1251)) ([d0a7bf2](https://github.com/percyfal/snakemake/commit/d0a7bf243c5df204136fa1f14706aab793793c68))
...
* improved display of percentage of done jobs ([1fee8c0](https://github.com/percyfal/snakemake/commit/1fee8c06d6ed229d7e3757de3c693e755d01d1bb))
* improved error handling for cluster status scripts and smarter job selector choice in case of cluster submission (use greedy for single jobs). ([#1142](https://github.com/percyfal/snakemake/issues/1142)) ([48d2dd9](https://github.com/percyfal/snakemake/commit/48d2dd99a745fd54b74b1435cbb7e41e0ee1b4ac))
* improved error message in case of target rule misspecification ([83b1f5b](https://github.com/percyfal/snakemake/commit/83b1f5bbde437e13641be2160f4855f54043c046))
...
* Initialize assignments dictionary when setting rule-based resources ([#1154](https://github.com/percyfal/snakemake/issues/1154)) ([68c13fd](https://github.com/percyfal/snakemake/commit/68c13fd6fb2ad458e79bafe146499b601bf4bd0e))
...
* issue [#1069](https://github.com/percyfal/snakemake/issues/1069) ([#1077](https://github.com/percyfal/snakemake/issues/1077)) ([7e34fda](https://github.com/percyfal/snakemake/commit/7e34fdaab6f1cc6257c449034cd49c4219eaf8e0))
* Issue [#1253](https://github.com/percyfal/snakemake/issues/1253) (problems editing Jupyter Notebooks) ([#1255](https://github.com/percyfal/snakemake/issues/1255)) ([3398ddf](https://github.com/percyfal/snakemake/commit/3398ddffd1f68182af768ef4ea519e9a9ad4efaf))
* issue [#1257](https://github.com/percyfal/snakemake/issues/1257) (missing logfile failure when using shadow directory) ([#1258](https://github.com/percyfal/snakemake/issues/1258)) ([426d92f](https://github.com/percyfal/snakemake/commit/426d92fd9610b61b414b7f0152d777c463c939a2))
...
* keep empty output and input dirs of --draft-notebook job ([f1181bd](https://github.com/percyfal/snakemake/commit/f1181bd41ea8b20fafd3975c2733ca1d439381dc))
...
* key error when handling FileNotFoundError in input functions. ([#1138](https://github.com/percyfal/snakemake/issues/1138)) ([d25f04d](https://github.com/percyfal/snakemake/commit/d25f04db820c9651835b7323baef5931d4f8dc0a))
...
* linting of remote snakefiles ([#1131](https://github.com/percyfal/snakemake/issues/1131)) ([2104e10](https://github.com/percyfal/snakemake/commit/2104e10d1d2c5e0f368e9c0fe95cc50f9d4847f1))
* merging of pipe groups when multiple rules are chained together via pipes ([#1173](https://github.com/percyfal/snakemake/issues/1173)) ([de91d2c](https://github.com/percyfal/snakemake/commit/de91d2ccf53bd844b4dbf4f64dd087f4ee935be5))
...
* more informative nothing to be done message ([#1234](https://github.com/percyfal/snakemake/issues/1234)) ([368d265](https://github.com/percyfal/snakemake/commit/368d265ff3da984bd3a53b319dcb882d6916975b))
...
* Only --bind Snakemake when we're working with a Python script ([#1206](https://github.com/percyfal/snakemake/issues/1206)) ([1d79f62](https://github.com/percyfal/snakemake/commit/1d79f625b7262d66def71c779f2a2c091bc418d8))
* only consider context of shell command for technical switches if called from snakemake rules. ([#1213](https://github.com/percyfal/snakemake/issues/1213)) ([4816a58](https://github.com/percyfal/snakemake/commit/4816a58653e466ca94b1482a1d947a856f5381b3))
...
* potential memory corruption caused by Google storage objects accessed from different threads ([#1174](https://github.com/percyfal/snakemake/issues/1174)) ([41a5071](https://github.com/percyfal/snakemake/commit/41a5071b750dca5d7fceec324d81d9a93c86bdb6))
...
* proper error message when defining cache eligibility for rules with multiple output files and no multiext declaration. ([#1357](https://github.com/percyfal/snakemake/issues/1357)) ([47b5096](https://github.com/percyfal/snakemake/commit/47b5096ebbdd3d94a9c99b443064b1b0de389c64))
...
* provide temporary IPYTHONDIR for notebook execution in order to avoid race conditions in https://github.com/ipython/ipython/blob/master/IPython/paths.py#L20 upon execution of multiple notebooks at the same time. ([#1280](https://github.com/percyfal/snakemake/issues/1280)) ([4d70da1](https://github.com/percyfal/snakemake/commit/4d70da11f810224ddce192ae1472a6380898865f))
...
* R encoding of pathlib.Path objects ([#1201](https://github.com/percyfal/snakemake/issues/1201)) ([bd516e9](https://github.com/percyfal/snakemake/commit/bd516e958af22e57c18cacf0cb22552c2a237bd8))
...
* remove whitespace before `` ([#1067](https://github.com/percyfal/snakemake/issues/1067)) ([bd7951a](https://github.com/percyfal/snakemake/commit/bd7951accc7854255a4d1ebd1edc35e739bac091))
...
* rule inheritance within modules (did previously lead to key errors) ([#1292](https://github.com/percyfal/snakemake/issues/1292)) ([603e0a8](https://github.com/percyfal/snakemake/commit/603e0a87d2c7af57a8f1d397605bc501c50934e0))
* run dependencies with non-existent ancient files before the consuming job ([#1202](https://github.com/percyfal/snakemake/issues/1202)) ([84d1f64](https://github.com/percyfal/snakemake/commit/84d1f6451b12352eba5a8bfefcfcce8b2d98c5aa)), closes [#946](https://github.com/percyfal/snakemake/issues/946)
* SameFileError [#1153](https://github.com/percyfal/snakemake/issues/1153) ([#1220](https://github.com/percyfal/snakemake/issues/1220)) ([ede313d](https://github.com/percyfal/snakemake/commit/ede313dcd31ea5f136b3b8f743e2265331475342))
...
* set default number of nodes to 1 in test cases ([#1288](https://github.com/percyfal/snakemake/issues/1288)) ([f6e12b4](https://github.com/percyfal/snakemake/commit/f6e12b4798485be3a1bb240b4af44d57dd5c84b2))
...
* skip global report caption when using a module ([#1379](https://github.com/percyfal/snakemake/issues/1379)) ([a755cee](https://github.com/percyfal/snakemake/commit/a755ceefa478d51070f926beed9090067771edf1))
...
* snakemake API using only 1 job as default ([#1283](https://github.com/percyfal/snakemake/issues/1283)) ([e92ad48](https://github.com/percyfal/snakemake/commit/e92ad4867feb456ce8ef3dc57fd8528affa64ae9))
* status cmd repeats until killed by 11 *different* signals ([#1207](https://github.com/percyfal/snakemake/issues/1207)) ([8b28b57](https://github.com/percyfal/snakemake/commit/8b28b5740c34149c9b5df56dbbfa034219eb1574))
...
* typo in sourcecache use ([#1229](https://github.com/percyfal/snakemake/issues/1229)) ([8b54bc5](https://github.com/percyfal/snakemake/commit/8b54bc5db9d8e5c0bcb8f2c2ff141dc075e3e659))
* typos in code examples ([#1324](https://github.com/percyfal/snakemake/issues/1324)) ([60010e4](https://github.com/percyfal/snakemake/commit/60010e4ef07b7ba9b89aa5f48ee90ff3cec85b75))
...
* Use 'snakemake.utils.update_config' instead of 'dict.update' ([#1126](https://github.com/percyfal/snakemake/issues/1126)) ([2658027](https://github.com/percyfal/snakemake/commit/2658027458dde4c10b3d6e1af7671564d175f9cb))
...
* wms monitor arg parsing now accepts any kind of value ([#1181](https://github.com/percyfal/snakemake/issues/1181)) ([313de93](https://github.com/percyfal/snakemake/commit/313de932e2e2a4f2c530df18c1abb15d37eb3217))
...
* XRootDHelper.exists supports non posix filesystem (object store) ([#1348](https://github.com/percyfal/snakemake/issues/1348)) ([7a3ad2f](https://github.com/percyfal/snakemake/commit/7a3ad2f438586690dd40e4c8ec591d8c10b22b00))


### Performance Improvements

* improve job selection performance in case of potential ambiguity that is resolved by comprehensive ruleorder statements. ([#1147](https://github.com/percyfal/snakemake/issues/1147)) ([921f4f7](https://github.com/percyfal/snakemake/commit/921f4f715e3814fc2e22a4f6527ff62e066cc5da))
* more extensive caching of source files, including wrappers. ([#1182](https://github.com/percyfal/snakemake/issues/1182)) ([bdb75f8](https://github.com/percyfal/snakemake/commit/bdb75f828a3ae27ba97ea6cd5e71a34ac7b27eea))


### Documentation

* add example for wrapper inclusion via GitHub url ([#953](https://github.com/percyfal/snakemake/issues/953)) ([e10cec9](https://github.com/percyfal/snakemake/commit/e10cec91d52f0f70c7e1de1d750b07314ed4534a))
...
* add sentence about workflow template to docs ([#1369](https://github.com/percyfal/snakemake/issues/1369)) ([5fabffb](https://github.com/percyfal/snakemake/commit/5fabffbb4af8e9e122677e5adeaebf2d6bd0eeb3))
...
* Clarification of --cluster-stats docs  &  elaborating on the situation where job ids are not passed to the status script ([#1221](https://github.com/percyfal/snakemake/issues/1221)) ([ed0e4a2](https://github.com/percyfal/snakemake/commit/ed0e4a27a2167a69a4fe1bcdf237dd27bb3732ca))
...
* Combine CHANGELOG.rst with CHANGELOG.md ([#1228](https://github.com/percyfal/snakemake/issues/1228)) ([19f5a43](https://github.com/percyfal/snakemake/commit/19f5a43261bd6ba548d6f01080640f0d4119871e))
* Command line arguments for configuration files ([#1343](https://github.com/percyfal/snakemake/issues/1343)) ([ad8aaa4](https://github.com/percyfal/snakemake/commit/ad8aaa4853a150211513baecc474956575d326eb))
...
* fix broken link in executor_tutorial/tutorial.rst ([#1360](https://github.com/percyfal/snakemake/issues/1360)) ([c9be764](https://github.com/percyfal/snakemake/commit/c9be76482d05577c4b1528b0e52ba15fc17a1dd5))
* fix contributing executors link ([#1112](https://github.com/percyfal/snakemake/issues/1112)) ([4bb58d1](https://github.com/percyfal/snakemake/commit/4bb58d12a44f77f79d47c5443f927cb6061677f5))
...
* Fix syntax error in docs/conf.py and update sphinx.ext.napoleon import ([#1084](https://github.com/percyfal/snakemake/issues/1084)) ([3e3fac2](https://github.com/percyfal/snakemake/commit/3e3fac2dbd5a8abad67e252f6181ad14bcfcb711))
* fix tutorial setup instructions for MacOS. ([#1383](https://github.com/percyfal/snakemake/issues/1383)) ([b57b749](https://github.com/percyfal/snakemake/commit/b57b7493d372605323204122af859ede38864e4d))
...
* Fix typo in file path in remote files documentation ([#1110](https://github.com/percyfal/snakemake/issues/1110)) ([9ce294f](https://github.com/percyfal/snakemake/commit/9ce294f6d5bdf72055a824ab610488a7f832a4d3))
* fix typo in installation.rst ([#1344](https://github.com/percyfal/snakemake/issues/1344)) ([c45d47a](https://github.com/percyfal/snakemake/commit/c45d47a79b78a1afed3b1319e6cafd1b2525fe43))
* Fix typo in rules.rst (—draft-notebook) ([#1290](https://github.com/percyfal/snakemake/issues/1290)) ([f5c42cf](https://github.com/percyfal/snakemake/commit/f5c42cfdc68f1516cec71b8ead8d78225ae915e5))
* link to list of dependencies from installation ([#1336](https://github.com/percyfal/snakemake/issues/1336)) ([99d7bfe](https://github.com/percyfal/snakemake/commit/99d7bfef1285f131d0e60331511bc4833e7e414a))
* Mention required openssl dep for rust-script ([#1216](https://github.com/percyfal/snakemake/issues/1216)) ([fc8c5f6](https://github.com/percyfal/snakemake/commit/fc8c5f62c397a0239ef213ab45a26a1def50f9eb))
* move note ([75a544b](https://github.com/percyfal/snakemake/commit/75a544ba528b30b43b861abc0ad464db4d6ae16f))
* move psutil import into benchmark methods to avoid needing it as a dependency for doc building ([6ffe38d](https://github.com/percyfal/snakemake/commit/6ffe38d1740294a7170765ab875b363f4ae82cd4))
* polish ([47a7b62](https://github.com/percyfal/snakemake/commit/47a7b628686258a28dd870f20bf1f121b3a881c3))
* require sphinx>=3 ([1773875](https://github.com/percyfal/snakemake/commit/1773875fc8f2fddb09362410afb7c49c4406bfa3))
...
* short tutorial updates ([#1286](https://github.com/percyfal/snakemake/issues/1286)) ([b653a44](https://github.com/percyfal/snakemake/commit/b653a44d105e4b3799425a695d75a08239dc0d6b))
...
* skip lazy property ([2883718](https://github.com/percyfal/snakemake/commit/28837183fa55a6764621580983b3d724f3881a6a))
...
* tutorial formatting ([594f5fb](https://github.com/percyfal/snakemake/commit/594f5fbb342e0722318641dea07d7da4c5eb8116))
* Unpin docutils version ([#1230](https://github.com/percyfal/snakemake/issues/1230)) ([15a82bf](https://github.com/percyfal/snakemake/commit/15a82bfe402b3577bf19e6d2eca3b2fb86109628))
...
* update URL to emacs snakemake-mode ([#1339](https://github.com/percyfal/snakemake/issues/1339)) ([dae7b8f](https://github.com/percyfal/snakemake/commit/dae7b8fb0e580a1878d36881cfb5ffc8adeaeb9f))
